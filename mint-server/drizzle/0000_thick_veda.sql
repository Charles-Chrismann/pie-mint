...
CREATE TABLE "sub_events" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "sub_events_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
...
CREATE TABLE "track_points" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "track_points_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"location" geometry(point) NOT NULL,
	"is_first_point" boolean NOT NULL,
	"is_last_point" boolean NOT NULL,
...
CREATE TABLE "action_levels" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "action_levels_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar
);
--> statement-breakpoint
...
ALTER TABLE "registrations" ADD CONSTRAINT "registrations_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sub_event_start_waves" ADD CONSTRAINT "sub_event_start_waves_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_events" ADD CONSTRAINT "sub_events_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_events" ADD CONSTRAINT "sub_events_standard_distance_id_standard_distances_id_fk" FOREIGN KEY ("standard_distance_id") REFERENCES "public"."standard_distances"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_events" ADD CONSTRAINT "sub_events_track_id_tracks_id_fk" FOREIGN KEY ("track_id") REFERENCES "public"."tracks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "time_barriers" ADD CONSTRAINT "time_barriers_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "track_segments" ADD CONSTRAINT "track_segments_start_position_id_track_points_id_fk" FOREIGN KEY ("start_position_id") REFERENCES "public"."track_points"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "track_segments" ADD CONSTRAINT "track_segments_end_position_id_track_points_id_fk" FOREIGN KEY ("end_position_id") REFERENCES "public"."track_points"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "medias" ADD CONSTRAINT "medias_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "custom_settings" ADD CONSTRAINT "custom_settings_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "profile_links" ADD CONSTRAINT "profile_links_sub_event_id_sub_events_id_fk" FOREIGN KEY ("sub_event_id") REFERENCES "public"."sub_events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "badges" ADD CONSTRAINT "badges_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;