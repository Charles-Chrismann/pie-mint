CREATE TABLE "action_levels" (
	...
	CONSTRAINT "action_levels_name_unique" UNIQUE("name")
);
...
CREATE TABLE "race_discipline_categories" (
	...
	"name" varchar(256) NOT NULL,
	CONSTRAINT "race_discipline_categories_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "race_discipline" (
	...
	CONSTRAINT "race_discipline_name_race_discipline_category_id_unique" UNIQUE("name","race_discipline_category_id")
);
--> statement-breakpoint
CREATE TABLE "standard_distances" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "standard_distances_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	"distance" numeric(10, 3) NOT NULL,
	CONSTRAINT "standard_distances_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "user_profiles" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "user_profiles_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	...
	"subscription_tier_id" integer DEFAULT 1 NOT NULL,
	CONSTRAINT "user_profiles_username_unique" UNIQUE("username"),
	CONSTRAINT "username_format_check" CHECK ("user_profiles"."username" ~ '^[A-Za-z][A-Za-z0-9._-]{3,63}$')
);
--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "visitors" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "visitors_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"code" varchar,
...
CREATE TABLE "event_campaigns" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "event_campaigns_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256) NOT NULL,
	"description" text
);
--> statement-breakpoint
...
CREATE TABLE "sponsors" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "sponsors_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar,
	"media_avatar_id" integer,
	"media_banner_id" integer,
...
CREATE TABLE "race_positions" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "race_positions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "race_start_waves" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "race_start_waves_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar,
...
CREATE TABLE "races" (
	...
	CONSTRAINT "event_requires_org" CHECK (
      "races"."event_id" IS NULL OR "races"."organization_id" IS NOT NULL
    ),
	CONSTRAINT "owner_must_be_alone" CHECK (
      "races"."owner_id" IS NULL OR 
      ("races"."event_id" IS NULL AND "races"."organization_id" IS NULL)
    ),
	CONSTRAINT "distance_and_standard_distance_should_not_be_defined_at_the_same_time" CHECK (
      "races"."distance" IS NULL OR "races"."standard_distance_id" IS NULL
    )
);
--> statement-breakpoint
...
CREATE TABLE "time_barriers" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "time_barriers_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	"is_end" boolean,
	"race_id" integer,
...
CREATE TABLE "track_segments" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "track_segments_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"track_id" integer,
...
CREATE TABLE "groups__permissions" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "groups__permissions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"group_id" integer,
	"permission_id" integer
);
--> statement-breakpoint
CREATE TABLE "groups__roles" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "groups__roles_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"group_id" integer,
	"permission_id" integer
);
--> statement-breakpoint
CREATE TABLE "groups__user_profiles" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "groups__user_profiles_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"group_id" integer,
...
CREATE TABLE "roles__permissions" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "roles__permissions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"role_id" integer,
	"permission_id" integer
);
--> statement-breakpoint
...
CREATE TABLE "countries" (
	...
	"french_translation" varchar NOT NULL,
	"english_translation" varchar,
	"self_translation" varchar,
	"flag_emoji" varchar,
	CONSTRAINT "countries_french_translation_unique" UNIQUE("french_translation")
);
--> statement-breakpoint
CREATE TABLE "languages" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "languages_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"french_translation" varchar NOT NULL,
	"english_translation" varchar,
	"self_translation" varchar,
	"bcp47" varchar,
	"country_id" integer NOT NULL,
	CONSTRAINT "languages_french_translation_unique" UNIQUE("french_translation")
);
--> statement-breakpoint
CREATE TABLE "translations" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "translations_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"key" varchar,
	"value" varchar,
...
CREATE TABLE "media_contexts" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "media_contexts_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	CONSTRAINT "media_contexts_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "media_formats" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "media_formats_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	CONSTRAINT "media_formats_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "media_types" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "media_types_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	"mime_type" varchar,
...
--> statement-breakpoint
CREATE TABLE "medias" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "medias_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"url" varchar,
	"is_system" boolean,
	"media_type_id" integer,
	"media_context_id" integer,
	"user_profile_id" integer,
	"organization_id" integer,
	"event_id" integer,
	"race_id" integer
...
CREATE TABLE "custom_settings" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "custom_settings_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"value" varchar,
	"user_profile_id" integer NOT NULL,
	"sponsor_id" integer NOT NULL,
	"organization_id" integer NOT NULL,
...
CREATE TABLE "setting_categories" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "setting_categories_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"is_global" boolean,
	"name_key" varchar,
	"description_key" varchar,
...
CREATE TABLE "setting_keys" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "setting_keys_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"label_key" varchar,
	"description_key" varchar,
...
CREATE TABLE "setting_multiple_options" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "setting_multiple_options_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"value_key" varchar,
...
CREATE TABLE "setting_selected_options" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "setting_selected_options_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"setting_multiple_option_id" integer NOT NULL,
	"setting_key_id" integer NOT NULL
);
--> statement-breakpoint
CREATE TABLE "setting_types" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "setting_types_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
	CONSTRAINT "setting_types_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "profile_links" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "profile_links_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"url" varchar,
...
CREATE TABLE "social_platforms" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "social_platforms_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar NOT NULL,
...
CREATE TABLE "badge_levels" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "badge_levels_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"level" integer,
	"description_key" varchar,
	"start" integer,
	"end" integer,
...
CREATE TABLE "badge_progressions" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "badge_progressions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"progress" integer,
...
CREATE TABLE "subscription_tier_features" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "subscription_tier_features_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
--> statement-breakpoint
CREATE TABLE "sub_tiers__sub_tier_feat" (
	"is_included" boolean NOT NULL,
	"subscription_tier_id" integer NOT NULL,
	"subscription_tier_feature_id" integer NOT NULL,
	CONSTRAINT "pk_subscription_tiers__subscription_tier_features" PRIMARY KEY("subscription_tier_id","subscription_tier_feature_id")
);
--> statement-breakpoint
CREATE TABLE "subscription_tiers" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "subscription_tiers_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256) NOT NULL,
	"subscription_id" integer
);
--> statement-breakpoint
...
ALTER TABLE "user_profiles" ADD CONSTRAINT "user_profiles_banner_media_id_medias_id_fk" FOREIGN KEY ("banner_media_id") REFERENCES "public"."medias"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_profiles" ADD CONSTRAINT "user_profiles_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_profiles" ADD CONSTRAINT "user_profiles_subscription_tier_id_subscription_tiers_id_fk" FOREIGN KEY ("subscription_tier_id") REFERENCES "public"."subscription_tiers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "race_start_waves" ADD CONSTRAINT "race_start_waves_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_standard_distance_id_standard_distances_id_fk" FOREIGN KEY ("standard_distance_id") REFERENCES "public"."standard_distances"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_track_id_tracks_id_fk" FOREIGN KEY ("track_id") REFERENCES "public"."tracks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_race_discipline_id_race_discipline_id_fk" FOREIGN KEY ("race_discipline_id") REFERENCES "public"."race_discipline"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "races" ADD CONSTRAINT "races_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_created_by_id_user_profiles_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."user_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "races" ADD CONSTRAINT "races_owner_id_user_profiles_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."user_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "registrations" ADD CONSTRAINT "registrations_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "time_barriers" ADD CONSTRAINT "time_barriers_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "medias" ADD CONSTRAINT "medias_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "custom_settings" ADD CONSTRAINT "custom_settings_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "profile_links" ADD CONSTRAINT "profile_links_race_id_races_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."races"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "subscription_tier_features" ADD CONSTRAINT "subscription_tier_features_subscription_id_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."subscriptions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_tiers__sub_tier_feat" ADD CONSTRAINT "sub_tiers__sub_tier_feat_subscription_tier_id_subscription_tiers_id_fk" FOREIGN KEY ("subscription_tier_id") REFERENCES "public"."subscription_tiers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sub_tiers__sub_tier_feat" ADD CONSTRAINT "sub_tiers__sub_tier_feat_subscription_tier_feature_id_subscription_tier_features_id_fk" FOREIGN KEY ("subscription_tier_feature_id") REFERENCES "public"."subscription_tier_features"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "subscription_tiers" ADD CONSTRAINT "subscription_tiers_subscription_id_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."subscriptions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_action_level_id_action_levels_id_fk" FOREIGN KEY ("action_level_id") REFERENCES "public"."action_levels"("id") ON DELETE no action ON UPDATE no action;