...
CREATE TABLE "race_positions" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "race_positions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "race_start_waves" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "race_start_waves_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar,
...
CREATE TABLE "race" (
	...
	CONSTRAINT "owner_must_be_alone" CHECK (
      "race"."owner_id" IS NULL OR 
      ("race"."event_id" IS NULL AND "race"."organization_id" IS NULL)
    )
);
--> statement-breakpoint
...
ALTER TABLE "race_positions" ADD CONSTRAINT "race_positions_user_profile_id_user_profiles_id_fk" FOREIGN KEY ("user_profile_id") REFERENCES "public"."user_profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "race_positions" ADD CONSTRAINT "race_positions_race_id_registrations_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."registrations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "race_start_waves" ADD CONSTRAINT "race_start_waves_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "registrations" ADD CONSTRAINT "registrations_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "registrations" ADD CONSTRAINT "registrations_race_start_wave_id_race_start_waves_id_fk" FOREIGN KEY ("race_start_wave_id") REFERENCES "public"."race_start_waves"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "time_barriers" ADD CONSTRAINT "time_barriers_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "medias" ADD CONSTRAINT "medias_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "custom_settings" ADD CONSTRAINT "custom_settings_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "profile_links" ADD CONSTRAINT "profile_links_race_id_race_id_fk" FOREIGN KEY ("race_id") REFERENCES "public"."race"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "race_discipline" ADD CONSTRAINT "race_discipline_race_discipline_category_id_race_discipline_categories_id_fk" FOREIGN KEY ("race_discipline_category_id") REFERENCES "public"."race_discipline_categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "unique_name_distance" ON "standard_distances" USING btree ("name","distance");